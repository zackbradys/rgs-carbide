...
helm upgrade -i airgapped-docs carbide-charts/airgapped-docs -n carbide-docs-system --version=0.1.53 --set global.cattle.systemDefaultRegistry=$CarbideRegistry
